...
export async function GET(request: NextRequest) {
  try {
    ...
    const evaluations = await prisma.externalValuesEvaluation.findMany({
...
export async function POST(request: NextRequest) {
  try {
    ...
    const evaluation = await prisma.externalValuesEvaluation.create({
      data: {
        title: title || 'Evaluación de Valores',
        description,
        recipientName,
        recipientEmail,

          ...
          <Card className="w-full max-w-2xl bg-white/80 backdrop-blur-sm border-0 shadow-xl">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Has completado exitosamente la evaluación de Estrés y Resiliencia.
              </p>
              <div className="bg-rose-50 border border-rose-200 rounded-lg p-4 mb-6">
                <h3 className="font-semibold text-rose-800 mb-2">Información de la Evaluación</h3>
                <div className="text-sm text-rose-700 space-y-1 text-left">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <p className="text-green-700 text-sm">
                  ...
                  Podrás recibir un reporte detallado de tu perfil de estrés y resiliencia.
                </p>
              </div>
            </CardContent>
          </Card>

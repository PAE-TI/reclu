...
export default async function DrivingForcesPage() {
  ...
  // Obtener evaluaciones de Fuerzas Motivadoras del usuario
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-lg text-gray-600">
              Gestiona y revisa todas tus evaluaciones de Fuerzas Motivadoras
            </p>
          </div>
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          <CardHeader>
            ...
            <CardDescription>
              Lista completa de tus evaluaciones de Fuerzas Motivadoras
            </CardDescription>
          </CardHeader>
          <CardContent>
            {evaluations.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6">Comienza creando tu primera evaluación de Fuerzas Motivadoras</p>
                <Link href="/driving-forces/new">
                  <Button className="bg-purple-600 hover:bg-purple-700">
                    <Plus className="w-4 h-4 mr-2" />
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <h3 className="text-lg font-semibold text-gray-900">
                            Evaluación Fuerzas Motivadoras
                          </h3>
                          <Badge
                            variant="secondary"
                      ...
                      <div className="flex gap-2 ml-4">
                        {evaluation.status === 'COMPLETED' && evaluation.results?.[0] && (
                          <Link href={`/driving-forces/results/${evaluation.results[0].id}`}>
                        ...
                        {evaluation.status === 'IN_PROGRESS' && (
                          <Link href={`/driving-forces/evaluation/${evaluation.id}/questionnaire`}>

...
export const metadata: Metadata = {
  title: 'Evaluaciones de Talento | Reclu - DISC, EQ, DNA-25, Acumen, Valores',
  description: 'Descubre las 8 evaluaciones científicas de Reclu: DISC, Fuerzas Motivadoras, Inteligencia Emocional, DNA-25, Acumen, Valores y Estrés. Análisis completo del talento humano.',
  ...
  openGraph: {
    title: 'Evaluaciones de Talento | Reclu',
